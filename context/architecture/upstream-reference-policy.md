...
- Use this repo as the source of truth for our intended deployment state, live snapshots, and operator history.
...
- Before changing tracked build config, repair flows, or design docs, re-check the related upstream docs and source code.
...
- Before editing `build/<host>/rootfs/home/*/.openclaw/openclaw.json` or deployment scripts.
