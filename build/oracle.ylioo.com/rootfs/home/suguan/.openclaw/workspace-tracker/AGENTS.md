...
- When the task is specifically about Knowhere store state, cleanup, or document inventory, you may use `knowhere_list_documents`, `knowhere_remove_document`, or `knowhere_clear_scope` directly.
